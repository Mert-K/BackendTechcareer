...
public class BookRepository : IBookRepository
{
    ...
    public BookRepository()
    {
        ...
        _bookData = new List<Book>()
        {
            ...
            new Book() { Id = 4,CategoryId="B", Description = "Çok değerli bir kitap", Price = 125, Stock = 1000, Title = "Cengiz Han'ın Hayatı"},
            new Book() { Id = 5,CategoryId="B", Description = "Çok değerli bir kitap", Price = 1020, Stock = 5000, Title = "Atilla"},
