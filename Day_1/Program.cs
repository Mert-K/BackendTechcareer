...
//        break;
//    default:
//        Console.WriteLine("Yanlış karakter gidiniz.");
//        break;
//}
...
//    6 => "Cumartesi",
//    7 => "Pazar",
//    _ => "Geçersiz karakter girdiniz." //default değer _ ile belirtilir.
//};
...
//Console.WriteLine("Sehirler dizisinde 'r' harfi geçen şehirler :");
...
//Console.WriteLine("Sehirler dizisinde A harfi ile başlayan şehirler :");
...
//Console.WriteLine("Sehirler dizisinde a harfi ile biten şehirler :");
//foreach (var item in sehirler)
//{
//    if(item.EndsWith('a'))
//    {
...
//Console.WriteLine("3 Kurala da uyan şehirler");
...
//Console.WriteLine("Şehirleri while döngüsüyle ekrana bastırma");
//int i = 0;
